...
class BasketBallInfo extends StatefulWidget {
  static const String id = 'Basketball_info';
  @override
  _BasketBallInfoState createState() => _BasketBallInfoState();
}

class _BasketBallInfoState extends State<BasketBallInfo> {
  @override
