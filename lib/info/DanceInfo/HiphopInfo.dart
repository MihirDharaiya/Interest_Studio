...
class HipHopInfo extends StatefulWidget {
  static const String id = 'hipHop_info';
  @override
  _HipHopInfoState createState() => _HipHopInfoState();
}

class _HipHopInfoState extends State<HipHopInfo> {
  @override
