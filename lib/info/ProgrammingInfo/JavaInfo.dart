...
class JavaInfo extends StatefulWidget {
  static const String id = 'java_info';
  @override
  _JavaInfoState createState() => _JavaInfoState();
}

class _JavaInfoState extends State<JavaInfo> {
  @override
